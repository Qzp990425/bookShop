		...
		<section id="sp-normalBook">
			...
			<div class="container">
				<div class="row" style="height:400px;border:1px solid #000;">
					...
					<div class="col-lg-9">
						<div class="input-group mb-2 mt-3 col-6">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1">手机号</span>
							</div>
							<input type="text" name="tel" id="username" class="form-control" placeholder="username" aria-label="username" aria-describedby="basic-addon1" value="${user.tel}" >
						</div>
						<div class="input-group mb-2 mt-3 col-6">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1">密码</span>
							</div>
							<input type="text" name="password" id="username" class="form-control" placeholder="username" aria-label="username" aria-describedby="basic-addon1" value="${user.password}">
						</div>
						<div class="input-group mb-2 mt-3 col-6">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1">真实姓名</span>
							</div>
							<input type="text" name="name" id="username" class="form-control" placeholder="username" aria-label="username" aria-describedby="basic-addon1" value="${user.name}">
						</div>
						<div class="input-group mb-2 mt-3 col-6">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1">创建日期</span>
							</div>
							<input type="text" name="createTime" id="username" class="form-control" placeholder="username" aria-label="username" aria-describedby="basic-addon1" value="${user.createTime}">
						</div>
						<div class="col-2.5">
							<button id="login" type="submit" class="btn btn-primary">更改</button>
						</div>												
					</div>									
				</div>
			</div>
